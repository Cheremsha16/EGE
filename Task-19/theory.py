...
# Если противник неудачник, то нам не важно как он походит. Главное, что он совершит неудачный ход и приведет нас к победе
...
# Мы должны победить при любом ходе противника. Т.е. он выстраивает стратегию и не будет совершать ходы, которые приведут его к проигрышу
